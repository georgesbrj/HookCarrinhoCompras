...
export function CartProvider({ children }: CartProviderProps): JSX.Element {
  ...
  const removeProduct = (productId: number) => {
    try {
      ...
      const productIndex = upDatedCart.findIndex(product => product.id === productId); //obtendo produto por id
  ...
  const updateProductAmount = async ({
    ...
    try {
      ...
      const productExists = upDatedCart.find(product => product.id === productId ); //obtendo o produto id
